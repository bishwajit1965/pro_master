...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <!-- Menu Body -->
                                <li class="user-body" style="background-color:#DDD;">
                                    <div class="row">
                                ...
                                <li class="user-footer" style="background-color:#DDD;">
                                    ...
                                    <div class="pull-right">
                                        <a href="logout.php" class="btn btn-sm btn-danger"><span class="glyphicon glyphicon-fast-backward"></span>
                                            Sign out</a>
                                    </div>
                                </li>
                            </ul>
                ...
                <div class="box">
                    ...
                    if (isset($_SESSION['userEmail'])) {
                        if ($_SESSION['userEmail'] == $user_home->getEmail()) {
                            echo '<a href="#" class="btn btn-sm btn-primary"><i class="fa fa-user"></i> Accessed</a>';
                        } else {
                            echo '<a href="#" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> Access Denied</a>';
                        }
                    }
                    echo '<br>';
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2014-2016 <a href="#">Aroma</a>.</strong> All rights
            reserved.
        </footer>
