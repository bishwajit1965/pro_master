                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="class" class="form-control">
                                        <option value="<?php echo $student->class; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="s_group" class="form-control">
                                        <option value="<?php echo $student->s_group; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="stipend" class="form-control">
                                        <option value="<?php echo $student->stipend; ?>" selected>
                                    <?php
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="engTut" id="engTut" placeholder="English tutorial">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="engAttend">English Attend</label>
                                            <input type="text" class="form-control" name="engAttend" id="engAttend" placeholder="English attendance">
                                        </div>
                                    </div>
                                </div>
                                <?php
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="IctAtten" id="IctAtten" placeholder="ICT-Atten">
                                                </div>
                                            </div>
                                        </div>
                                <?php
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="PhyAtten" id="PhyAtten" placeholder="Phy-Atten">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="CheAtten" id="CheAtten" placeholder="Che-Atten">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="CheAtten" id="CheAtten" placeholder="Bio-Atten">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <?php if (!empty($student->photo)) {
                        ?>
                    <img src="../students/<?php echo $student->photo; ?>" alt="Photo" style="width:100%;height:180px; border-radius: 5px;">
                    <?php
                    } else {
                        ?>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="BioAtten" id="BioAtten" placeholder="Bio-Atten">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="CheAtten" id="CheAtten" placeholder="Mat-Atten">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="AgrAtten" id="AgrAtten" placeholder="AgrAtten">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
