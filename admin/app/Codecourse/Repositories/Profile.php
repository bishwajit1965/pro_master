            ...
            if ($stmt->rowCount() > 0) {
                ...
                while ($profile = $stmt->fetch(PDO::FETCH_OBJ)) {
                    ...
                    <tr>
                        ...
                        <td><?php echo $profile->userEmail; ?></td>
                        <td>
                            <?php $profile->userRole;
                        ...
                        <td>
                            <a href="editProfile.php?edit_id=<?php echo $profile->userID; ?>" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i> Edit</a>

                            <a href="deleteProfile.php?delete_id=<?php echo $profile->userID; ?>" class="btn btn-sm btn-danger" onClick="return confirm('Are you sure to delete trhis data ???')";><i class="fa fa-trash"></i> Delete</a>
                        </td>
                    </tr>
                    <?php
                }
                    ...
                    <div class="col-sm-6 col-sm-offset-3">
                        <form action="" method="post">
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" name="userID" value="<?php echo $profile->userID; ?>" disabled>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="userEmail" value="<?php echo $profile->userEmail; ?>">
                            </div>
                            <div class="form-group">
                ...
                while ($profile = $stmt->fetch(PDO::FETCH_OBJ)) {
                    ...
                    <div class="col-sm-6 col-sm-offset-3">
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                <label for="firstName">First Name</label>
                                <input type="text" class="form-control" value="<?php echo $profile->firstName; ?>">
                            </div>
                            <div class="form-group">
                                <label for="firstName">Last Name</label>
                                <input type="text" class="form-control" value="<?php echo $profile->lastName; ?>">
                            </div>
                            <div class="form-group">
                                <label for="userRole">User Role</label>
                                <select name="userRole" id="" class="form-control">
                            ...
                            <div class="form-group">
                                <label for="userID">User Email</label>
                                <input type="text" class="form-control" value="<?php echo $profile->userEmail; ?>">
                            </div>
                            <div class="form-group">
